            ...
            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Chỉnh sửa bài viết: <?= $blog['title'] ?></h4>
                    </div>
                    <div class="card-body">
                        <form action="code.php" method="POST" enctype="multipart/form-data"><!-- Uploads image -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="full-name" required name="title" placeholder="Nhập tiêu đề" value="<?= $blog['title'] ?>" class="form-control"> 
                                </div>                               
                                <div class="col-md-12">
                                <br>
                                    <label for=""><b>Slug</b></label>
                                    <input type="text" id="slug-name" required name="slug" placeholder="Nhập slug" value="<?= $blog['slug'] ?>" class="form-control">
                                </div>                                                        
                                <div class="col-md-12">
                                <br>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" required="" style="height: 150px" name="small_content" placeholder="Nhập mô tả" class="form-control mb-2"><?= $blog['small_content'] ?></textarea>
                                </div>
                                <div class="col-md-12">
                                <br>
