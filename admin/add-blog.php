                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST" enctype="multipart/form-data"><!-- Uploads image -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                <br>
                                    <label class="mb-0"><b>Sự kiện</b></label>
                                    <textarea type="text" style="height: 150px" required="" name="small_content" placeholder="Nhập sự kiện" class="form-control mb-2"></textarea>
                                </div>
                                <div class="col-md-12">
                                <br>
                                    <label for=""><b>Sự kiện chi tiết</b></label>
