                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data"><!-- Uploads image -->
                            <div class="row">
                                ...
                                <br>
                                    ...
                                    <textarea type="text" required name="small_description" placeholder="Nhập mô tả" class="form-control mb-2"></textarea>
                                </div>                               
                                <div class="col-md-12">
                                <br>
                                    <label class="mb-0"><b>Mô tả chi tiết</b></label>
                                    <textarea type="text" required name="description" placeholder="Nhập mô tả chi tiết" class="form-control mb-2"></textarea>
                                </div>
                                <div class="col-md-6">
                                <br>
                                ...
                                <div class="col-md-6">
                                <br>
                                    <label class="mb-0"><b>Số lượng hàng còn</b></label>
                                    <input type="number" required name="qty" placeholder="Nhập số lượng" class="form-control mb-2"> 
                                </div> 
                                <div class="col-md-6">
                                <br>
                                <br>
